const translations = {
  hr: {
    ...
    whyChooseUs: {
      ...
      title: 'Izrađeno s',
      subtitle: 'Preciznošću i Brigom',
      description:
        'Svaki komad koji stvaramo svjedoči našoj predanosti izvrsnosti, kombinira naprednu tehnologiju s obrtničkim majstorstvom.',
      features: {
        speed: {
          title: 'Brza dostava',
          description: 'Brza obrada i isporuka unutar 3-5 radnih dana',
        },
        quality: {
          title: 'Color-Perfect jamstvo',
          description:
            'Napredna kalibracija boja osigurava da vaši printovi točno odgovaraju vašoj viziji, svaki put.',
        },
        support: {
          title: 'Vrhunska kvaliteta',
          description: 'Premium materijali i precizna izrada',
        },
      },
      stats: {
        satisfaction: 'Zadovoljstvo kupaca',
        delivered: 'Dostavljeni printovi',
        industry: 'Industrijski',
        leader: 'Lider',
      },
    },
    process: {
  ...
  en: {
    ...
    whyChooseUs: {
      ...
      description:
        'Every piece we create is a testament to our commitment to excellence, combining cutting-edge technology with artisanal craftsmanship.',
      features: {
        speed: {
          title: 'Lightning Fast',
          description: 'Quick processing and delivery within 3-5 business days',
        },
        quality: {
          title: 'Color-Perfect Guarantee',
          description:
            'Advanced color calibration ensures your prints match your vision exactly, every time.',
        },
        support: {
          title: 'Premium Quality',
          description: 'Premium materials and precise craftsmanship',
        },
      },
      stats: {
        satisfaction: 'Customer Satisfaction',
        delivered: 'Prints Delivered',
        industry: 'Industry',
        leader: 'Leader',
      },
    },
